...
const ComponentComponent = () => {
    return (
<div class="container my-24 px-6 min-h-screen mx-auto py-64 min-h-screen">


  <section class="mb-32 text-gray-800">
    <div class="flex justify-center">
      <div class="text-center lg:max-w-3xl md:max-w-xl">
        <h2 class="text-3xl font-bold mb-12 px-6">Hubungi Kami</h2>
      </div>
    </div>
        ...
        <div class="flex flex-wrap">
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex items-start">
              ...
              <div class="grow ml-6">
                <p class="font-bold mb-1">Email & Telefon</p>
                <p class="text-gray-500">bhakti.karya.mulya@gmail.com</p>
                <p class="text-gray-500">(0291) 4251615/4249906</p>
              </div>
            </div>
          </div>
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex items-start">
              ...
              <div class="grow ml-6">
                ...
                <p class="text-gray-500">Jl. R. Agil Kusumadya No. 111, Jati Wetan,
Rt.02 Rw.01 Jati, Kabupaten Kudus</p>
          ...
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex align-start">
              ...
              <div class="grow ml-6">
                <p class="font-bold mb-1">Whatsapp Marketing 1</p>
                <p class="text-gray-500">Johan</p>
                <p class="text-gray-500">0821 3600 3185</p>
              </div>
            </div>
          </div>
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex align-start">
              ...
              <div class="grow ml-6">
                <p class="font-bold mb-1">Whatsapp Marketing 2</p>
                <p class="text-gray-500">Vania</p>
                <p class="text-gray-500">0898 5521 221</p>
              </div>
            </div>
          </div>
        </div>
